...
It is recommended to import the package in a new project first. Assets that you like to use can be exported / imported.  Or the package can be imported in your project if you want to use all assets.
