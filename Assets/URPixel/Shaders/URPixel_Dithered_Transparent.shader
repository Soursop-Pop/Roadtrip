Shader "URPixel/URPixel_Dithered_Transparent"
{
    Properties
    {
        ...
        // New alpha multiplier property (allows you to modulate overall transparency)
    ...
    SubShader
    {
        Tags
        {
            ...
            "RenderType"="TransparentCutout"      // Changed from "Opaque"
            "UniversalMaterialType" = "Unlit"
            "Queue"="AlphaTest"           // Changed from "Geometry"
        ...
        Pass
        {
            ...
            // Render State – set for transparency
                Blend One Zero
                ZWrite On
                ZTest LEqual
                Cull Back
                // No partial blending for a cutout
                // Turned off for transparent objects
            
            HLSLPROGRAM
            // Pragmas, multi_compile, and includes remain the same:
            #pragma target 2.0
        ...
        float _Alpha;    // Add this if you use it.
        float _Cutoff;   // <-- Add _Cutoff here
        CBUFFER_END
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float alpha = _SampleTexture2D_cf72802ce3f046109f2aee022557650d_RGBA_0_Vector4.a;
            clip(alpha - _Cutoff);
        ...
        // All other passes (DepthOnly, DepthNormalsOnly, ShadowCaster, etc.) are left unchanged.
        // They can remain as originally authored or be adjusted further if needed.
        Pass
        {
            Name "DepthOnly"
            Tags
