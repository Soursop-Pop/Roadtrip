...
public class DepthNormalsFeature : ScriptableRendererFeature
{
    class DepthNormalsPass : ScriptableRenderPass
    {
        ...
        {
            cmd.GetTemporaryRT(depthAttachmentHandle.GetInstanceID(), depthAttachmentHandle.referenceSize.x, depthAttachmentHandle.referenceSize.y, descriptor.depthBufferBits, FilterMode.Point);
